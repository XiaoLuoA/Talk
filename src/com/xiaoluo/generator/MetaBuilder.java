...
public class MetaBuilder {
	...
	//数据库方言,默认为MySQL
	protected Dialect dialect = Dialect.MysqlDialect;
	...
	protected ResultSet getTablesResultSet() throws SQLException {
		String schemaPattern = dialect ==Dialect.OracleDialect ? dbMeta.getUserName() : null;
...
//			}
	...
	protected void buildPrimaryKey(TableMeta tableMeta) throws SQLException {
		...
		if (StrKit.isBlank(primaryKey)) {
			System.out.println(tableMeta.name+" don't have primaryKey");
		}
	...
	protected void buildColumnMetas(TableMeta tableMeta) throws SQLException {
		String sql = dialect.getDialet(tableMeta.name);
